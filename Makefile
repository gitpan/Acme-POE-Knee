# This Makefile is for the Acme::POE::Knee extension to perl.
#
...
FULLEXT = Acme\POE\Knee
BASEEXT = Knee
PARENT_NAME = Acme::POE
DLBASE = $(BASEEXT)
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)\Acme\POE
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\Acme\POE
...
EXPORT_LIST = Knee.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = demo_race.pl \
	demo_simple.pl \
	lib/Acme/POE/Knee.pm

PM_TO_BLIB = demo_simple.pl \
	$(INST_LIBDIR)\demo_simple.pl \
	demo_race.pl \
	$(INST_LIBDIR)\demo_race.pl \
	lib/Acme/POE/Knee.pm \
	$(INST_LIB)\Acme\POE\Knee.pm
...
Knee.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'Acme::POE::Knee', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f  $(INST_LIBDIR)\demo_simple.pl $(INST_LIBDIR)\demo_race.pl
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f $(INST_LIB)\Acme\POE\Knee.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Acme-POE-Knee\" VERSION=\"1,00,0,0\">\n}. qq{\t<TITLE>Acme-POE-Knee</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Acme-POE-Knee.ppd
